...
public class AnnotationProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        for (Element elem : roundEnv.getElementsAnnotatedWith(ExampleAnnotation.class)) {
            ...
            classesFound.add(elem.toString());
        }
    ...
    private void writeSourceCode(List<String> classesFound) throws JClassAlreadyExistsException, IOException {
        ...
        for (String className : classesFound) {
