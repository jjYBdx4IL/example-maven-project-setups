 ...
 */
public class CellTableFieldUpdaterComplexExample extends SimpleLayoutPanel {
     ...
     * unique ID.
     */
    private static final ProvidesKey<Contact> KEY_PROVIDER = new ProvidesKey<CellTableFieldUpdaterComplexExample.Contact>() {
        @Override
    ...
    public CellTableFieldUpdaterComplexExample() {
